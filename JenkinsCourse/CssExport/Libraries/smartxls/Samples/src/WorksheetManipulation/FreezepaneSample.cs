...
{
    public class FreezepaneSample : BaseFileViewControl, ISampleControl
    {
        public FreezepaneSample()
        {
            InitializeComponent();
        }
        ...
        public override void buttonView_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                m_book.freezePanes(0, 0, 8, 6, false);
        ...
        string ISampleControl.CodePath
        {
            get
            {
                return "src\\WorksheetManipulation\\FreezepaneSample.cs";
            }
        }
    }
}
