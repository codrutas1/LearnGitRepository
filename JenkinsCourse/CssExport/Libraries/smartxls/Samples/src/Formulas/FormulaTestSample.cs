...
{
    public partial class FormulaTestSample : BaseFileViewControl, ISampleControl
    {
        public FormulaTestSample()
            : base()
        {
            InitializeComponent();
        }
        ...
        public override void buttonView_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                m_book.setColWidth(0, 10 * 256);
                m_book.setColWidth(1, 25 * 256);
                m_book.setColWidth(2, 25 * 256);
                m_book.setColWidth(4, 14 * 256);
                m_book.setColWidth(5, 14 * 256);

                m_book.setText(rowIndex, 1, "result");
                m_book.setText(rowIndex, 2, "formula");
                System.String nextFunction = "ABS(-1)";
                m_book.setFormula(++rowIndex, 1, nextFunction);
                m_book.setText(rowIndex, 2, nextFunction);
                ...
                m_book.setText(rowIndex, 2, nextFunction);
                // Sample data
                m_book.setText(0, 3, "Employee");
                m_book.setText(0, 4, "Income");
                m_book.setText(0, 5, "Salary");
                m_book.setText(1, 3, "Mike");
                m_book.setText(2, 3, "Jone");
                m_book.setText(3, 3, "Peter");
                m_book.setText(4, 3, "Johanson");
                m_book.setNumber(1, 4, 15000);
                m_book.setNumber(2, 4, 25000);
                m_book.setNumber(3, 4, -65000);
                m_book.setNumber(4, 4, 28000);
                m_book.setNumber(1, 5, 15000);
                m_book.setNumber(2, 5, 25000);
                m_book.setNumber(3, 5, 30000);
                m_book.setNumber(4, 5, 27000);
                m_book.setText(5, 4, "Income");
                m_book.setText(6, 4, "<0");
                m_book.setText(5, 5, "Income");
                m_book.setText(6, 5, ">0");
                m_book.setSelection(0, 4, 4, 5);
                RangeStyle cfm = m_book.getRangeStyle();
        ...
        string ISampleControl.CodePath
        {
            get
            {
                return "src\\Formulas\\FormulaTestSample.cs";
            }
        }
    }
}
